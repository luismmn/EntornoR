...
function validarDatosEditar(listaInputs, ejecutarFormulario) {
	var datosFormulario = $("#formularioEditar").serializeArray();
	...
	datosFormulario.forEach(function (campo) {
		return form.append(campo.name, campo.value);
	});
...
function datosActualizar() {
	...
	fetch("servidor/datosActualizar.php", {
		...
		var nombreAntiguo = document.getElementById("nombreEditarSelect").value;
		var nombreNuevo = document.getElementById("nombreEditar").value;
